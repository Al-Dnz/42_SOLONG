...
{
	static char* numbers_txt_arr[10] = {"./numbers_txt/0.xpm", "./numbers_txt/1.xpm", "./numbers_txt/2.xpm", "./numbers_txt/3.xpm", "./numbers_txt/4.xpm", "./numbers_txt/5.xpm", "./numbers_txt/6.xpm", "./numbers_txt/7.xpm" ,"./numbers_txt/8.xpm", "./numbers_txt/9.xpm"}; 
	int	i;

	i = 0;
	while (i < 10)
	{
		(state->number_img[i]).mlx_img = mlx_xpm_file_to_image(state->mlx,  numbers_txt_arr[i], &(state->number_img[i].width), &(state->number_img[i].height));
